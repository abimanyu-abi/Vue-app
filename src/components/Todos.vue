<template>
  ...
  >
    <div
      class="topContainer w-full sticky top-0 left-0 z-10 text-center bg-amber-200 pt-20 pb-3"
    >
      <!-- Title -->
      <h1 class="font-bold text-7xl text-zinc-900">Todo App</h1>
      <!-- Add Todo Container -->
      <div class="input my-12 w-full px-14 lg:px-56 flex flex-wrap">
        ...
        />
        <button
          class="w-full lg:w-1/5 cursor-pointer bg-zinc-900 text-white font-bold py-3 px-8"
          @click="addTodo()"
        >
          Add Todo
        </button>
